package com.iprody.inventory.health;
...
public class KafkaHealthIndicator implements HealthIndicator {
    ...
    private final Set<String> requiredTopics = Set.of(
            KafkaEventTopic.INVENTORY_REQUEST,
            KafkaEventTopic.INVENTORY_RESPONSE,
            KafkaEventTopic.CANCELLATION_REQUEST,
            KafkaEventTopic.CANCELLATION_RESPONSE
    );
